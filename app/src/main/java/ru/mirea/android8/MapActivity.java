...
public class MapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Mapbox.getInstance(this, "pk.eyJ1IjoibWF4bm9vciIsImEiOiJja2Foam42aWgwaDg1MnRveXlkanlhc29mIn0.GcSL1n14KMWMhVu9JwXrfw");
    ...
    private void getRoute(MapboxMap mapboxMap, Point origin, Point destination) {
        client = MapboxDirections.builder()
                ...
                .accessToken("pk.eyJ1IjoibWF4bm9vciIsImEiOiJja2Foam42aWgwaDg1MnRveXlkanlhc29mIn0.GcSL1n14KMWMhVu9JwXrfw")
                .build();
